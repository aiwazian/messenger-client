    ...
    CompositionLocalProvider(LocalNavHost provides backStack) {
        NavDisplay(
            ...
            entryProvider = entryProvider {
                ...
                entry<AppRoute.SettingsUsername> { SettingsUsernameScreen() }
                entry<AppRoute.SettingsBio> { SettingsBioScreen() }
                entry<AppRoute.SettingsDateOfBirth> { SettingsDateOfBirthScreen() }
