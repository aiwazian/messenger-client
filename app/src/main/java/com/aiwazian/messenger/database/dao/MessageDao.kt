...
interface MessageDao {
    ...
    @Query("DELETE FROM message WHERE chatId = :chatId AND sendTime >= :minTime AND id NOT IN (:ids)")
    suspend fun deleteMessagesInRangeExcluding(chatId: Long, minTime: Long, ids: List<Long>)
